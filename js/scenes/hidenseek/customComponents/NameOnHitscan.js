...
function NameOnHitScan() {
  this.isHit = false;
  this.wasHit = false;
}

NameOnHitScan.prototype.init = function (go) {
...
NameOnHitScan.prototype.update = function (go, deltaTime) {
...
NameOnHitScan.prototype.onHitScan = function (go) {
  if ( !this.isHit && !this.wasHit ){
